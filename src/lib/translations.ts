...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.game": "YOUR RIDE",
    "hero.subtitle":
      "Authentic Car Parts, Accessories & more. Delivered to your door.",
    ...
    "why.authentic_desc":
      "Every part verified genuine. We source directly from top manufacturers.",
    "why.performance": "Performance Parts",
    // 'why.performance_desc': 'Latest tech from top automotive brands.',
    "why.delivery": "Fast Delivery",
    "why.delivery_desc":
      "Express delivery across the country. Same-day dispatch available.",
    ...
    "newsletter.subtitle":
      "Early access to new parts, exclusive deals, and automotive updates.",
