...
const DealerDashboard = () => {
  ...
  const { data: dealerOrders = [], isLoading: ordersLoading } =
    useCustomerOrders(user?.email);
      ...
      <div className="flex-grow container mx-auto px-4 py-6 md:py-8 mt-28 md:mt-36">
        <div className="container mx-auto lg:px-4 px-1 space-y-6">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700 font-body">
                    <strong>Your account is pending approval.</strong> Until an
                    admin approves your account, you will see regular customer
                    prices and can order without the minimum wholesale quantity.
                    Once approved, you will unlock exclusive dealer pricing!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="font-heading text-2xl md:text-3xl font-extrabold uppercase tracking-widest text-gray-900">
                Dealer Dashboard
              </h1>
              <p className="font-body text-gray-500 mt-1">
                Manage your wholesale account and track orders
              </p>
            </div>
            <div className="flex items-center gap-3 w-full md:w-auto">
              <Link
                to="/parts"
                className="bg-primary text-white px-6 py-3 md:py-2.5 rounded-xl font-bold uppercase tracking-wider text-sm hover:bg-primary/90 transition-colors shadow-sm w-full text-center block"
              >
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            ...
            <div className="md:col-span-1 bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 h-fit md:sticky md:top-24">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    {profile?.is_approved ? (
                      <span className="flex items-center gap-1 text-xs font-bold text-green-600 bg-green-50 px-2 py-1 rounded-full">
                        <CheckCircle2 className="w-3 h-3" /> Approved Dealer
                      </span>
                    ) : (
                ...
                {profile?.plain_password && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 font-mono bg-gray-50 px-2 py-0.5 rounded border border-gray-100 inline-block">
                        {profile.plain_password}
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                <button
                  ...
                  className="w-full py-2.5 text-red-600 font-bold uppercase tracking-wider text-sm hover:bg-red-50 rounded-xl transition-colors"
                >
                  Sign Out
                </button>
              </div>
            ...
            <div className="md:col-span-2 bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 mt-6 md:mt-0">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="font-heading text-xl font-bold uppercase tracking-wider text-gray-900">
                  Your Orders
                </h2>
              </div>
              ...
              {ordersLoading ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-200">
                  ...
                  <p className="text-sm text-gray-500 mb-4">
                    You haven't placed any wholesale orders.
                  </p>
                  <Link
                    to="/parts"
                      ...
                      <div className="space-y-3 mt-4">
                        {((order.items as any[]) || []).map((item, i) => {
                          ...
                          return (
                            <div
                              key={i}
                              className="flex items-center gap-3 md:gap-4 text-sm text-gray-600 bg-gray-50 p-2.5 md:p-2 rounded-lg"
                            >
