...
const ReceivablePartiesPage = () => {
  ...
  const partiesWithBalance = useMemo(() => {
    ...
    return parties;
  }, [customers, trialBalance, customerDueMap, searchTerm, activeTab, balanceFilter, sortField, sortOrder]);
          ...
          <div className="p-4 border-b border-gray-100">
            ...
            <div className="flex items-center justify-between mt-3 text-xs">
              ...
              <span className="text-gray-400 text-xs">
                {partiesWithBalance.length} {activeTab === "customer" ? "Customers" : "Dealers"}
              </span>
            </div>
          ...
          <div className="flex-1 overflow-y-auto">
              ...
              >
                ...
                <div
                  className={`font-semibold ${
                    party.balance > 0 ? "text-red-500" : "text-emerald-600 font-medium"
                  }`}
                >
            ...
            {partiesWithBalance.length === 0 && (
              <div className="p-8 text-center text-gray-500 text-sm">
                {balanceFilter === "due"
                  ? "No customers or dealers with due balance found."
                  : "No customers or dealers found."}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="flex-1 bg-white flex flex-col overflow-hidden">
          {selectedParty ? (
            <>
              ...
              <div className="p-6 border-b border-gray-200 flex justify-between items-start">
                <div>
                  ...
                  <div className="text-xs text-gray-500">Phone & Contact</div>
                  ...
                  <div className="text-right">
                    ...
                    <div
                      className={`text-xl font-bold ${
                        selectedParty.balance > 0 ? "text-red-500" : "text-emerald-600"
                      }`}
                    >
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-gray-400 gap-2">
              ...
              <div>Select a customer or dealer from the list to view details</div>
            </div>
          )}
        </div>
      </div>
